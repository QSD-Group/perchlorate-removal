...
load('bed_volumes_2ppb.mat')

bed_volumes_2ppb_lhsempir=lhs_empir(bed_volumes_2ppb,10000);
...
regeneration_cycles=bed_volume_water_7year./bed_volumes_2ppb_lhsempir; %number of regeneration cycles for ion exchange.
