...
load('bed_volumes_10ppb.mat')

bed_volumes_10ppb_lhsempir=lhs_empir(bed_volumes_10ppb,10000);
...
regeneration_cycles=bed_volume_water_7year./bed_volumes_10ppb_lhsempir; %number of regeneration cycles for ion exchange.
