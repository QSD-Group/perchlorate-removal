...
k_reactor_CO=((log(ClO4_Influent)-log(ClO4_Effluent))/HRT_CCO); %activity in the reactor requied to reudce the influent perchlorate to designated effluent concentration.
