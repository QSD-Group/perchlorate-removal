...
ElectronDonor_ClO4_CO=umole_mmole*(ClO4_Influent-ClO4_Effluent)*electron_eq_ClO4/electron_eq_H2; %Concentration of electron donor (mmole/L) to remove perchlorate 
