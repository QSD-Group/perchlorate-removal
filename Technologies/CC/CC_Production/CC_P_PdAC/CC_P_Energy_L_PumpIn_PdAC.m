...
%Catalyst PdAC Production Tank Fill (CPTF_PdAC)
...
T_CPTF_PdAC=1./(gallon_liter*Q_CPTF_PdAC)*min_hrs; %Time to fill 1L into the tank in hours
E_CPTF_PdAC=P_CPTF_PdAC.*T_CPTF_PdAC; %Work (kWhr) to move 1L of media into the tank
