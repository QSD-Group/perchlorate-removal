...
CC_Media_Required_L_DW_m3=CC_Media_Required_L_DW/L_m3; 
...
kWhr_C_Operation_m3_DW=ECOT_NoAeration/L_m3; 
...
cost_CP_total_m3_DW=cost_C_palladium_AC_m3_DW+cost_C_water_m3_DW...
    +cost_C_hydrochloric_acid_m3_DW+cost_C_ammonium_perrhenate_m3_DW;
...
cost_CO_total_m3_DW=cost_CO_hydrogen_m3_DW+cost_CO_hydrochloric_acid_m3_DW...
    +cost_CO_electricity_m3_DW+cost_CO_NaClO;
...
% 
%% EXCEL FILE OUTPUT
CatalystsTotals='CatalystsTotals_NoAeration.xlsx';
xlswrite(CatalystsTotals,cost_C_Total,1);
xlswrite(CatalystsTotals,CF_C_Total,2);

CatalystsCostsProduction='CatalystsCostsProduction_NoAeration.xlsx';

xlswrite(CatalystsCostsProduction,cost_CP_total_m3_DW,1);
xlswrite(CatalystsCostsProduction,cost_C_palladium_AC_m3_DW,2);
xlswrite(CatalystsCostsProduction,cost_C_water_m3_DW,3);
xlswrite(CatalystsCostsProduction,cost_C_hydrochloric_acid_m3_DW,4);
xlswrite(CatalystsCostsProduction,cost_C_ammonium_perrhenate_m3_DW,5);
xlswrite(CatalystsCostsProduction,cost_CP_electricity_m3_DW,6);

CatalystsCostsOperation='CatalystsCostsOperation_NoAeration.xlsx';
xlswrite(CatalystsCostsOperation,cost_CO_total_m3_DW,1);
xlswrite(CatalystsCostsOperation,cost_CO_hydrogen_m3_DW,2);
xlswrite(CatalystsCostsOperation,cost_CO_hydrochloric_acid_m3_DW,3);
xlswrite(CatalystsCostsOperation,cost_CO_electricity_m3_DW,4);
xlswrite(CatalystsCostsOperation,cost_CO_NaClO,5);

CatalystsCFProduction='CatalystsCFProduction_NoAeration.xlsx';
xlswrite(CatalystsCFProduction,CF_C_P_Total,1);
xlswrite(CatalystsCFProduction,CF_CC_palladium_AC,2);
xlswrite(CatalystsCFProduction,CF_CC_water,3);
xlswrite(CatalystsCFProduction,CF_CC_hydrochloric_acid,4);
xlswrite(CatalystsCFProduction,CF_CC_ammonium_perrhenate,5);
xlswrite(CatalystsCFProduction,CF_CC_P_electricity,6);
xlswrite(CatalystsCFProduction,CF_CC_P_transportation,7);

CatalystsCFOperation='CatalystsCFOperation_NoAeration.xlsx';
xlswrite(CatalystsCFOperation,CF_C_O_Total,1);
xlswrite(CatalystsCFOperation,CF_CC_O_electron_donor,2);
xlswrite(CatalystsCFOperation,CF_CC_O_cleaning,3);
xlswrite(CatalystsCFOperation,CF_CC_O_hydrochloric_acid,4);
xlswrite(CatalystsCFOperation,CF_CC_O_electricity,5);
xlswrite(CatalystsCFOperation,CF_CC_O_transportation,6);

CatalystsCFConstruction='CatalystsCFConstruction_NoAeration.xlsx';
