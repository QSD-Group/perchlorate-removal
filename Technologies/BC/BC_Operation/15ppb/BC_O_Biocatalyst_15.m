...
v_reactor_BO_15=(Km_Perchlorate_BO.*(log(ClO4_Influent)-log(ClO4_Effluent_15))+(ClO4_Influent-ClO4_Effluent_15))/HRT_BO; %the reactor rate required to treat perchlorate down to the desired level in umole/min
Biocatalyst_Dosing_BO=v_reactor_BO_15./Vmax_ClO4_Adjusted_NO3_Temp_OB; %Biocatalyst Dosing Rate in ug of Molybdenum per 1L of treated water
Volume_Dosing_BO=Biocatalyst_Dosing_BO./L_ug_BO; %The volume of biocatalyst solution to treat 1L of water in L
Production_Media_Required_L_DW_BO_15=Volume_Dosing_BO./Yield_BO; %Production Media Volume (L) required to treat 1L of drinking water
