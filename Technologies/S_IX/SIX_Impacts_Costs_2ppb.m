...
cost_SIX_transportation_m3_DW=(kg_SIX_total/1000).*Transportation_Distance_Operation.*price_transportation; %divide by 1000 to convert to tons
...
SIXCFOperation='SIX_2ppb_CFOperation.xlsx';
