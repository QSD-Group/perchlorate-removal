...
kWhr_WC_Operation_m3_DW=(EWCOT_NoAeration)/L_m3; %conversion is for L to m3 of DW
...
%% EXCEL FILE OUTPUT
WCTotals='WCTotals_NoAeration.xlsx';
xlswrite(WCTotals,cost_WC_total,1);
xlswrite(WCTotals,CF_WC_Total,2);

WCCostsOperation='WCCostsOperation_NoAeration.xlsx';
xlswrite(WCCostsOperation,cost_WCO_total_m3_DW,1);
xlswrite(WCCostsOperation,cost_acetic_acid_WC_m3_DW,2);
xlswrite(WCCostsOperation,cost_phosphoric_acid_WC_m3_DW,3);
xlswrite(WCCostsOperation,cost_NaClO_WC_m3_DW,4);
xlswrite(WCCostsOperation,cost_electricity_WC_m3_DW,5);

WCCFOperation='WCCFOperation_NoAeration.xlsx';
xlswrite(WCCFOperation,CF_WC_O_Total,1);
xlswrite(WCCFOperation,CF_WC_O_electron_donor,2);
xlswrite(WCCFOperation,CF_WC_O_electricity,3);
xlswrite(WCCFOperation,CF_WC_O_cleaning,4);
xlswrite(WCCFOperation,CF_WC_O_phosphoric_acid,5);
xlswrite(WCCFOperation,CF_WC_O_transportation,6);

WCCFConstruction='WCCFConstruction_NoAeration.xlsx';
